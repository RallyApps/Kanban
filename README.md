...
This app is deprecated and no longer being actively developed. Please use the new Kanban board on our app-catalog [here](https://github.com/RallyApps/app-catalog/tree/master/src/apps/kanban).
